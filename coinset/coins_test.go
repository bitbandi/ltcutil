...
import (
	...
	"github.com/bitbandi/luxutil/coinset"
)

type TestCoin struct {
	TxHash     *chainhash.Hash
	TxIndex    uint32
	TxValue    luxutil.Amount
	TxNumConfs int64
}

func (c *TestCoin) Hash() *chainhash.Hash { return c.TxHash }
func (c *TestCoin) Index() uint32         { return c.TxIndex }
func (c *TestCoin) Value() luxutil.Amount { return c.TxValue }
...
func NewCoin(index int64, value luxutil.Amount, numConfs int64) coinset.Coin {
	h := sha256.New()
...
var (
	...
	testSimpleCoinTxValue0            = luxutil.Amount(3500000)
	...
	testSimpleCoinTx, _               = luxutil.NewTxFromBytes(testSimpleCoinTxBytes)
