...
/*
This test file is part of the luxutil package rather than than the
luxutil_test package so it can bridge access to the internals to properly test
...
import (
	"github.com/bitbandi/luxutil/bech32"
