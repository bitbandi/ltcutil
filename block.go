...
// Tx returns a wrapped transaction (luxutil.Tx) for the transaction at the
...
// Transactions returns a slice of wrapped transactions (luxutil.Tx) for all
...
// instead provides easy access to wrapped versions (luxutil.Tx) of them.
