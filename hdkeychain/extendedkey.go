...
func (k *ExtendedKey) Child(i uint32) (*ExtendedKey, error) {
	...
	parentFP := luxutil.Hash160(k.pubKeyBytes())[:4]
...
func (k *ExtendedKey) Address(net *chaincfg.Params) (*luxutil.AddressPubKeyHash, error) {
	pkHash := luxutil.Hash160(k.pubKeyBytes())
	return luxutil.NewAddressPubKeyHash(pkHash, net)
}
